...
function Level(plan) {
  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
      ...
      //else if (ch == "=")//bullet
        //fieldType = "bullet";
      else if (ch == "w") //spring1
        fieldType = "spring";
      else if (ch == "q") //spring2, super spring
        fieldType = "superSpring";
...
function Player(pos) {
  ...
  this.size = new Vector(1, 1); //original .8, 1.5 bc 80% of 20 is 16, 1.5 of 20 is 30
...
var gravity = 20; //30 increasing is worse lol
var jumpSpeed =10; //17
